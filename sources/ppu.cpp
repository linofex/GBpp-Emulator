...
std::vector<RGBColor> Ppu::getSpritePixelLine(sprite t_sprite, BYTE t_currentline) {  
    BYTE height = 8;
    ...
    return pixelOfASpriteLine;
}


void Ppu::renderSpriteLine(BYTE t_currentline) {  
    std::vector<RGBColor> spritePixelsLine;
    sprite spriteInfo;
                ...
                if(isSpriteOnTop(spriteInfo.attribs) || 
                  (!isSpriteOnTop(spriteInfo.attribs) && RGBBuffer[t_currentline*160 + startX + j].r == 0xFC)) {
                    ...
                    //if(spritePixelsLine.at(j).r < RGBBuffer[t_currentline*160 + startX + j].r) { 
                        ...
                        RGBBuffer[t_currentline*160 + startX + j] = spritePixelsLine.at(j);
